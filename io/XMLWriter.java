...
public class XMLWriter<T extends Comparable<T> & Identifiable> extends FileManager<T> implements Writer {
    public XMLWriter(String inputFileName, CollectionManager<T> collectionManager, ObjectMapper objectMapper, Class<T> tClass) {
