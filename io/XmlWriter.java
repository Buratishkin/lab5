...
public class XmlWriter {
     ...
     */
    public static void writeCitiesToFile(String fileName, List<City> cities) throws FileWriteException {
     ...
     */
    private static void writeCity(BufferedWriter writer, City city) throws IOException {
        writer.write("  <city>\n");
     ...
     * @throws IOException если произошла ошибка при записи.
     */
    private static void writeElement(BufferedWriter writer, String tagName, Object value) throws IOException {
     ...
     * @throws IOException если произошла ошибка при записи.
     */
    private static void writeOptionalElement(BufferedWriter writer, String tagName, Object value) throws IOException {
        if (value != null) {
     ...
     * @throws IOException если произошла ошибка при записи.
     */
    private static void writeCoordinates(BufferedWriter writer, Coordinates coordinates) throws IOException {
     ...
     * @throws IOException если произошла ошибка при записи.
     */
    private static void writeHuman(BufferedWriter writer, Human human) throws IOException {
        if (human != null) {
