...
public class ValidationManager {
    ...
    public void nullCheck(Object cls, boolean isNull){
        if (!isNull && cls == null){
     ...
     */
    public <T extends Number & Comparable<T>> T validateCondition(T value, int signCode, T compareTo) {
        List<BiPredicate<T, T>> conditions = List.of(
